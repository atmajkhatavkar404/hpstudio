...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      { title: "Contact Us — HP Studio Photography" },
      { name: "description", content: "Get in touch with HP Studio for premium wedding, baby shoot, pre-wedding, and event photography. Book your session today." },
      { property: "og:title", content: "Contact HP Studio" },
      { property: "og:description", content: "Reach out to book your next photoshoot with HP Studio." },
    ],
  }),
});
