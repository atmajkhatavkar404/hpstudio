...
export const Route = createFileRoute("/portfolio")({
  ...
  head: () => ({
    meta: [
      { title: "Portfolio — HP Studio Wedding & Event Photography" },
      { name: "description", content: "Browse HP Studio's portfolio of weddings, pre-weddings, baby shoots, and event photography." },
      { property: "og:title", content: "HP Studio Portfolio" },
      { property: "og:description", content: "Real moments, captured beautifully." },
    ],
  }),
});
...
function AlbumCard({ album }: { album: AlbumInfo }) {
  return (
    <Link
      to="/story/$category/$album"
      params={{ category: album.category, album: album.slug }}
