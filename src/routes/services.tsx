...
export const Route = createFileRoute("/services")({
  ...
  head: () => ({
    meta: [
      { title: "Services & Pricing — HP Studio Photography" },
      { name: "description", content: "Wedding, pre-wedding, commercial, event coverage, post-production, and premium wedding cinematography services by HP Studio." },
      { property: "og:title", content: "HP Studio Services & Pricing" },
      { property: "og:description", content: "Cinematic photography & videography packages tailored to your story." },
    ],
  }),
});
